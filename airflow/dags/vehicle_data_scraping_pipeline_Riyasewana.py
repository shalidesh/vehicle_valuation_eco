...
from components.post_data_extraction import scarpe_and_save_riyasewana
...
scrape_vehicle_info_from_link = PythonOperator(
    ...
    python_callable=scarpe_and_save_riyasewana,
    op_kwargs={'source_table': 'riyasewana_vehicle_post_links','data_table': 'riyasewana_post_data'}, 
    on_success_callback = success_email,
    on_failure_callback = failure_email,
    provide_context = True,
    dag=dag,
...
preprocess_data = PythonOperator(
    ...
    op_kwargs={'source_table': 'riyasewana_post_data','data_table': 'riyasewana_post_data_preprocced'}, 
    on_success_callback = success_email,
    on_failure_callback = failure_email,
    provide_context = True,
    dag=dag,
